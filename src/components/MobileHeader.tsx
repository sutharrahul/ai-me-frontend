...
export default function MobileHeader({ onOpenSidebar, onNewChat, online }: MobileHeaderProps) {
  ...
  return (
    <>
      ...
      <header className="relative z-50 flex items-center justify-between border-b border-neutral-200 bg-white/80 px-2 py-2.5 backdrop-blur md:hidden dark:border-white/10 dark:bg-neutral-950/80">
        <button
          type="button"
